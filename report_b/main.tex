...
% header font
\addfontfamily{
    Path = {../mexdown/fonts/nimbus-sans-l/} ,
    Extension = .ttf ,
...
% body font
\addfontfamily{
    Path = {../mexdown/fonts/liberation_sans/} ,
    Extension = .ttf ,
...
% source code font
\addfontfamily{
    Path = {../mexdown/fonts/source-code-pro/OTF/} ,
    Extension = .otf ,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
    \input{../shared/titlepage}                % Include the title page
    ...
    \inputmarkdown{chapters}{chap1}
    \inputmarkdown{chapters}{chap2}
